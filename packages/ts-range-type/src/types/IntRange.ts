import { Enumerate, EnumerateExclusive, EnumerateInclusive } from 'ts-enumerate-type';
...
export type IntRange<From extends number, To extends number> = IntRangeInclusive<From, To>;
